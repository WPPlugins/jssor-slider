...
class WP_Jssor_Slider_Update
{
    ...
    public function request_remote_update_info()
    {
        ...
        $request = wp_remote_post(esc_url_raw($this->remote_update_info_url), array(
            'body' => array(
    ...
    private function retrieve_remote_version_info()
    {
        ...
        $response = wp_remote_post(esc_url_raw($this->remote_version_info_url), array(
            'body' => array(
                'data' => json_encode($data)
            ),
            'timeout' => 30
        ...
        if (!is_wp_error($response) || wp_remote_retrieve_response_code($response) === 200) {
            ...
            update_option('wjssl-connection', true);
            ...
            update_option('wjssl-connection', false);
