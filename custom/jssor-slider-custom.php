...
function wp_jssor_template_redirect()
{
    ...
    if(!empty($jssor_extension)){
        ...
        if ($jssor_extension == "media_browser"){
            ...
            wp_enqueue_script('wp-jssor-media-browser-init-script', WP_JSSOR_SLIDER_URL.'custom/media/js/wp.jssor.media.browser.init-1.0.1.min.js');

            include(WP_JSSOR_SLIDER_PATH . 'custom/media/media-browser.php');
        ...
        {
            include(WP_JSSOR_SLIDER_PATH . 'custom/import/import-slider-with-progress.php');
        ...
        {
            include(WP_JSSOR_SLIDER_PATH . 'custom/preview/preview-slider.php');
        ...
        {
            include(WP_JSSOR_SLIDER_PATH . 'custom/build/download-build-zip.php');
