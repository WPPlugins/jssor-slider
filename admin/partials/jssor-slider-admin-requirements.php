...
<div data-u="jssor-slider-requirements-view" class="wjssc-dash-block wjssl-requirements-widget">
    <?php
$dir = wp_upload_dir();
...
$has_gd = WP_Jssor_Slider_Utils::get_gd_library_installed();
    ...
    <div data-u="requirements-view-title" class="wjssc-dash-title <?php echo esc_attr($dash_rr_status); ?>">
        <div class="wjssc-dash-title-text">
            <?php _e("System Requirements",WP_JSSOR_SLIDER_DOMAIN); ?>
        </div>
        <div class="wjssc-dash-title-signal wjssc-dash-title-signal-problem">
            <span class="wjssc-iconm wjssc-iconm-problem"></span>&nbsp;&nbsp;<?php _e("Problem Found",WP_JSSOR_SLIDER_DOMAIN); ?>
        </div>
        <div class="wjssc-dash-title-signal wjssc-dash-title-signal-ok">
            ...
            <span class="wjssc-dash-title-signal-text">
                <?php _e("No Problems",WP_JSSOR_SLIDER_DOMAIN); ?>
            </span>
        </div>
    </div>
    ...
    <div class="wjssc-dash-content">
        ...
        <div class="wjssc-dash-label" style="width:195px;">
            <?php _e('Uploads folder writable', WP_JSSOR_SLIDER_DOMAIN); ?>
        </div>
        ...
        <div class="wjssc-dash-label" style="width:195px;">
            <?php _e('PHP GD library is installed', WP_JSSOR_SLIDER_DOMAIN); ?>
        </div>
        ...
        <div class="wjssc-dash-label" style="display:none;width:195px;">
            <?php _e('Media Browser Accessibility', WP_JSSOR_SLIDER_DOMAIN); ?>
        </div>
        ...
        <span data-u="media-browser-accessibility-status-notice" class="wjssc-dash-emphasis" style="display:none;margin-left:20px;">
            <a data-u="command" data-command="media_browser_accessibility_fix_problem" href="#">Fix Problem</a>
        </span>

        <!-- check max upload file size -->
        <div style="height:3px;"></div>
        <span class="wjssc-dash-label" style="width:195px;">
            <?php _e('Upload Max. Filesize', WP_JSSOR_SLIDER_DOMAIN); ?>
        </span>
        ...
        <span class="wjssc-dash-emphasis" style="margin-left:20px">
            <?php echo __('Currently:', WP_JSSOR_SLIDER_DOMAIN).' '.$upload_max_filesize; ?>
        </span>
        ...
        <div style="height:3px;"></div>
        <span class="wjssc-dash-label" style="width:195px;">
            <?php _e('Max. Post Size', WP_JSSOR_SLIDER_DOMAIN); ?>
        </span>
        ...
        <span class="wjssc-dash-emphasis" style="margin-left:20px">
            <?php echo __('Currently:', WP_JSSOR_SLIDER_DOMAIN).' '.$post_max_size; ?>
        </span>
        ...
        <div style="height:3px;"></div>
        <span class="wjssc-dash-label" style="width:195px;">
            <?php _e('Contact www.jssor.com Server', WP_JSSOR_SLIDER_DOMAIN); ?>
        </span>
        ...
        <span data-u="command" data-command="connect_jssor_com_server" class='wjssc-dash-detect-btn' style="margin-left:16px">
            <a href="#"><?php _e("Check Now",WP_JSSOR_SLIDER_DOMAIN); ?></a>
        </span>
    </div>
</div>
